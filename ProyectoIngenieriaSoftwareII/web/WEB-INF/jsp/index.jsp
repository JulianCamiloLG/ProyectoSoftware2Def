      ...
      <div class="portfolio-items">
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a  href="././Vistas/VistasEstudiante/publicarInquietud.jsp">Publicar Inquietud</a><br>
              <div class="hover-text">
                <h4>Publicar inquietud</h4>
                <small>Web Design</small>
                <div class="clearfix"></div>
              </div>
              <img src="img/portfolio/01.jpg" class="img-responsive" alt="Publicar Inquietud"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="././Vistas/VistasEstudiante/VisualizarNota.jsp">Ver Nota</a>
              <div class="hover-text">
                <h4>Ver Nota</h4>
